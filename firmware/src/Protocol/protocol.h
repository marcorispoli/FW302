 ...
 * 
 * 
 * This Module implements the functions of the PCB/22-302 Software Communication protocol specifications.
 * 
 * ## Dependencies
 * 
 ...
 */
     ...
     */
        ...
        static const unsigned char   MET_CAN_APP_DEVICE_ID    =  0x11 ;     //!< Application DEVICE CAN Id address
